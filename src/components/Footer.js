        ...
        <div style={{ 
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '15px' }}>
              {/* Social Media Icons */}
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--light-text)', fontSize: '20px', transition: 'color 0.3s ease', '&:hover': { color: 'var(--primary-color)' } }} title="Twitter">
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" style={{ color: 'white', fontSize: '20px', transition: 'color 0.3s ease' }} title="Instagram">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://discord.com" target="_blank" rel="noopener noreferrer" style={{ color: 'white', fontSize: '20px', transition: 'color 0.3s ease' }} title="Discord">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              ...
              <li><a href="/pre-order" style={{ color: 'var(--light-text)', textDecoration: 'none', transition: 'color 0.3s ease', '&:hover': { color: 'var(--primary-color)' } }}>Pre-Order</a></li>
            </ul>
          </div>
          <div>
